...
import edu.ufl.cise.gatorraider.models.Maze;

import edu.ufl.cise.lib.io.BlockFileInputStream;
...
public final class _Maze implements Maze
{
    ...
    protected _Maze(DataFile gameDir, String nodeFile, String distanceFile)
    {
        loadNodes(gameDir, nodeFile);
        loadDistances(gameDir, distanceFile);
    }

    //Loads all the nodes from files and initialises all maze-specific information.
    private void loadNodes(DataFile gameDir, String fileName)
    {
        ...
        try
        {
            ...
            BlockFileInputStream stream = new DataFile(gameDir, fileName).getNewFileInputStream();
...
//            BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(_Game.pathMazes + System.getProperty("file.separator") + fileName)));
     ...
     */
    private void loadDistances(DataFile gameDir, String fileName)
    {
